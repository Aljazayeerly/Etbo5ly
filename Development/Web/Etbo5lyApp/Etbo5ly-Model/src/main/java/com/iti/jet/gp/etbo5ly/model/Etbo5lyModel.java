package com.iti.jet.gp.etbo5ly.model;
/*
...
import com.iti.jet.gp.etbo5ly.model.pojos.Cook;
import com.iti.jet.gp.etbo5ly.model.pojos.CookStatus;
import com.iti.jet.gp.etbo5ly.model.pojos.Customer;
import com.iti.jet.gp.etbo5ly.model.pojos.Document;
import com.iti.jet.gp.etbo5ly.model.pojos.DocumentType;
import com.iti.jet.gp.etbo5ly.model.pojos.MenuItems;
import com.iti.jet.gp.etbo5ly.model.pojos.Order;
import com.iti.jet.gp.etbo5ly.model.pojos.OrderDetails;
import com.iti.jet.gp.etbo5ly.model.pojos.OrderDetailsId;
import com.iti.jet.gp.etbo5ly.model.pojos.OrderStatus;
import com.iti.jet.gp.etbo5ly.model.pojos.StatusHasOrder;
import com.iti.jet.gp.etbo5ly.model.pojos.StatusHasOrderId;
import com.iti.jet.gp.etbo5ly.model.pojos.Tags;
...
public class Etbo5lyModel {
	...
	public Cook addCook(ApplicationContext factory) {
		...
		System.out.println("status : " + cookStatus.getStatus());
...
//	// ///////////////////////////////////////////////////////////////////////////
	...
	public Order addOrder(ApplicationContext factory) {
		...
		order.setUserByCookId(getCook(factory, 1));
...
//		Set orderStatus = new HashSet(0);
	...
	public OrderDetails addOrderDetails(ApplicationContext factory,int id) {
		...
		MenuItems menuItems = getMenuItems(factory, 9);
...
//		etbo5lyModel.addMenuItems(factory);
		/*MenuItems menuItems = etbo5lyModel.getMenuItems(factory, 9);
		System.out.println(menuItems.getDescriptionEn());
		System.out.println(menuItems.getDescriptionAr());*/
		//---------------------------------------------------------------
//		
//		Customer customer = etbo5lyModel.addCustomer(factory);
	...
	private static ApplicationContext getBeanFactory() {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext(
				"com/iti/jet/gp/etbo5ly/model/Beans.xml");
