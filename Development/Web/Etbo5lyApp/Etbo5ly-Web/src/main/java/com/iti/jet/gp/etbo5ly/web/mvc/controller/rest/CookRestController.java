...
//    }
    @RequestMapping(value = "/joinUS", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<CookDTO> registerCook(@RequestBody CookDTO cook) {
        System.out.println("inside the RegisterCook controller");
