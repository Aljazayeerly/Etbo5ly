...
<div class="col-md-6" id="registerbox">
    <div class="box"  ng-controller="JoinUsController">
        ...
        <form:form  method="post" commandName="cook" name="cook">
            ...
            <div class="form-group">
                ...
                <input  class="form-control"  name="email" id="email" path="email" ng-model="email" required="true" type="email" ng-blur="checkCookMail()">
...
<!--                 <div id="emailErrors">{{$scope.AlreadyCustomer}}</div>-->
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-primary" id="rButton" ng-click="registerCook(name,email,password,phone,address)"><i class="fa fa-user-md"></i> <fmt:message key="register"/></button>
            </div>
        </form:form>
    </div>
</div>
