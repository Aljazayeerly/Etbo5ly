...
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('3', 'Salad with Grilled Chicken', '', '33', '200g Grilled chicken strips surrounded by greens, low cal dressing and pickles& mushroom Perfect for a light lunch ', '', '4', '4', 'images(3).jpg');
...
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('5', 'Rice with Grilled Chicken', '', '45', 'Delicious rice with nuts (Raisins+Almonds+Walnuts), grilled chicken breast & Caesar Salad,a complete meal.', '', '4', '6', 'images(5).jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('6', 'Pasta & Chicken Salad', '', '30', 'Just like how your MUM or Grandmother would cook it. perfect comforting lunch after a long hard day.', ' ', '5', '2', 'images(6).jpg');
