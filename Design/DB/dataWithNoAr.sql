...
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('1', 'Rocca Quinoa with  salad', '', '39', 'Delicious and healthy salad that contains Rocca , Quinoa , Cherry tomatoes, Olive oil and halumi grilled cheese', '', '3', '2', 'image1.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('2', 'Vegetarian potato salad', '', '20', 'potatoes 500gm with sweet corn, pickles & onions with a sauce of light olive oil, lemon and coriander', '', '5', '3', 'image2.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('3', 'Salad with Grilled Chicken (207cal)', '', '33', '200g Grilled chicken strips surrounded by greens, low cal dressing and pickles& mushroom Perfect for a light lunch ', '', '4', '4', 'image3.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('4', 'chicken with Baked Potato', '', '40', 'Perfectly baked chicken and potato with honey mustard sauce for a match made in Heaven taste Ö try it now !!!', '', '3', '5', 'image4.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('5', 'Rice with Nuts+Grilled Chicken Breast+Caesar ', '', '45', 'Delicious rice with nuts (Raisins+Almonds+Walnuts), grilled chicken breast & Caesar Salad,a complete meal.', '', '4', '6', 'image5.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('6', 'Red Sauce Pasta & Chicken Panne Salad', '', '30', 'Just like how your MUM or Grandmother would cook it. perfect comforting lunch after a long hard day.', ' ', '5', '2', 'image6.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('7', 'Lebanese fatta with Pomegranate molasses (Debs ', '', '14', 'A lebaneese specialty that will make u crave it day and night.caramelized onions and chicken in debs roman sauce ', '', '2', '3', 'image7.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('8', 'Lentils Soup', '', '25', 'Warm yourself up with our rich lentil soup topped with our crispy croutons and a hint of lemon', '', '4', '4', 'image8.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('9', 'Mushroom Soup', '', '30', 'Tummy warming blend that will keep you wanting more', '', '4', '5', 'image9.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('10', 'Vegetarian glass noodles', '', '18', 'Perfectly cooked Chinese glass noodles with a mix of bell peppers and exquisite Chinese sauce that makes a party in ', '', '2', '6', 'image10.jpg');
INSERT INTO `etbo5ly`.`menu_items` (`item_id`, `name_en`, `name_ar`, `price`, `description_en`, `description_ar`, `item_rate`, `cook_id`, `image_URL`) VALUES ('11', 'Sojok Eskandarani Pasta', '', '27', 'Mouth watering sujok rings with onions and green peppers over a bed of red sauce pasta', '', '3', '2', 'image11.jpg');
