...
-- -----------------------------------------------------
-- Table `etbo5ly`.`country`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `etbo5ly`.`country` ;

CREATE  TABLE IF NOT EXISTS `etbo5ly`.`country` (
  `country_id` INT NOT NULL ,
  `country_name` VARCHAR(45) NOT NULL ,
  `country_name_ar` VARCHAR(45) NULL ,
...
-- Table `etbo5ly`.`city`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `etbo5ly`.`city` ;

CREATE  TABLE IF NOT EXISTS `etbo5ly`.`city` (
  `city_id` INT NOT NULL ,
  `city_name` VARCHAR(45) NOT NULL ,
  `city_name_ar` VARCHAR(45) NULL ,
  `country_id` INT NOT NULL ,
  PRIMARY KEY (`city_id`) ,
  INDEX `fk_city_country1_idx` (`country_id` ASC) ,
  CONSTRAINT `fk_city_country1`
    FOREIGN KEY (`country_id` )
    REFERENCES `etbo5ly`.`country` (`country_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `etbo5ly`.`region`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `etbo5ly`.`region` ;

CREATE  TABLE IF NOT EXISTS `etbo5ly`.`region` (
  `region_id` INT NOT NULL ,
  `region_name` VARCHAR(45) NOT NULL ,
  `region_name_ar` VARCHAR(45) NULL ,
  `city_id` INT NOT NULL ,
  PRIMARY KEY (`region_id`) ,
  INDEX `fk_region_city1_idx` (`city_id` ASC) ,
  CONSTRAINT `fk_region_city1`
    FOREIGN KEY (`city_id` )
    REFERENCES `etbo5ly`.`city` (`city_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `etbo5ly`.`user` (
  ...
  CONSTRAINT `fk_user_region1`
    ...
    REFERENCES `etbo5ly`.`region` (`region_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 40
...
CREATE  TABLE IF NOT EXISTS `etbo5ly`.`order` (
  ...
  INDEX `fk_order_region1_idx` (`region_id` ASC) ,
