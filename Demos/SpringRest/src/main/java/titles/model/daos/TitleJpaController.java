...
@Repository
public class TitleJpaController{
    ...
    public List<Title> findTitlesByTitle(String searchString) {
        
        List<Title> titles=getEntityManager().createNamedQuery("Title.findByTitle",Title.class).setParameter("title","%"+searchString+"%").getResultList();
        return titles;
    }
